...
def main():
    ...
    for i in range(n):
                ...
                if found_sweep_offset != -1:
                    ...
                    for k in range(found_sweep_offset + 1):
                        ...
                        if found_sweep_dir == 1: # Bullish setup
                            ...
                            if bos_up_1m_log[idx_k]:
                                reversal_tf = "1m"
                            elif bos_up_5m_log[idx_k]:
                                if reversal_tf != "1m":
                                    reversal_tf = "5m"
                            ...
                            if bos_down_1m_log[idx_k]:
                                reversal_tf = "1m"
                            elif bos_down_5m_log[idx_k]:
                                if reversal_tf != "1m":
                                    reversal_tf = "5m"
        ...
        if state == 2:
            ...
            if invalidation_triggered and valid_setup == 1:
                ...
                if sweep_dir == 1: # Bullish
                    ...
                    if bos_down_1m_event:
                        reversal_tf = "1m"
                    elif bos_down_5m_event:
                        if reversal_tf != "1m":
                            reversal_tf = "5m"
        ...
        if valid_setup == 1:
            ...
            high_extreme = struct_1m.latest_ph if struct_1m.latest_ph is not None else h
