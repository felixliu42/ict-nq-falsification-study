...
def main():
    ...
    # Run 6-Month rolling walk-forward validation (W=1800 setups)
    base_features = [
    ...
    print("Running 6-Month rolling walk-forward validation (this will take about a minute)...")
    ...
    print("\n" + "="*115)
    print("6-MONTH ROLLING WINDOW YEARLY BREAKDOWN (0.25 Threshold, Split TP1/TP2)")
    print("="*115)
