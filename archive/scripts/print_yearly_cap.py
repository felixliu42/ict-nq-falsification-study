...
def main():
    ...
    print(f"\nSimulated {len(trade_outcomes)} trades. Skipped {skipped} due to R > 60 pts.")
    
    print("\n" + "="*115)
    print("6-MONTH ROLLING WINDOW + 60-POINT RISK CAP YEARLY BREAKDOWN (0.25 Threshold, Split TP1/TP2)")
    print("="*115)
